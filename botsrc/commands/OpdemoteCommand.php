<?php
     ...
     * Demote an operator
     */
    class OpdemoteCommand extends UserCommand
    {
        /**
         * @var string
         */
        protected $name = 'Opdemote';

        /**
         * @var string
         */
        protected $description = 'Allows a main operator to demote another operator';

        /**
         * @var string
         */
        protected $usage = '/opdemote [ID/PTID/Username]';
        ...
        public function execute()
        {
             ...
             if ($UserStatus->IsOperator != true)
             {
                 return Request::sendMessage([
                     ...
                     "reply_to_message_id" => $this->getMessage()->getMessageId(),
                     "parse_mode" => "html",
                     "text" => LanguageCommand::localizeChatText($this->WhoisCommand, "This user is not an operator")
                 ]);
             }
             ...
             return Request::sendMessage([
                 ...
                 "reply_to_message_id" => $this->getMessage()->getMessageId(),
                 "parse_mode" => "html",
                 "text" => LanguageCommand::localizeChatText($this->WhoisCommand, "Success, this user is no longer an operator")
             ]);
        }
        ...
        public function displayUsage(Message $message, string $error="Missing parameter")
        {
            return Request::sendMessage([
                ...
                "text" =>
                    ...
                    "   <b>/opdemote</b> [PTID/ID/Username]\n".
                    LanguageCommand::localizeChatText($this->WhoisCommand, "For further instructions, send /help opdemote")
            ]);
        }
    }